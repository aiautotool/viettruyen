...
export default function Home() {
  ...
  const [activeTab, setActiveTab] = useState<'content' | 'podcast' | 'gptvoice'>('content');
                  ...
                  <div className="bg-gray-700 rounded-xl p-5 mb-4">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xl font-semibold text-blue-400">
                        <i className="fas fa-book-open mr-2"></i> {storyOutline.title}
                      </h3>
                      <Button
                        variant="outline"
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-gray-300 text-sm">
                        <span className="text-gray-400">Thời gian đọc dự kiến:</span> {storyOutline.estimatedReadingTime} phút
                      </p>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-gray-400 font-medium mb-1">Tóm tắt cốt truyện:</h4>
                      <p className="text-gray-300 bg-gray-800 p-3 rounded-lg">{storyOutline.outline}</p>
                    </div>
                  ...
                  {fullStory.podcastContent ? (
                    <div className="tabs-container">
                      ...
                      <div className="bg-gray-800 p-2 sm:p-4 rounded-lg max-h-72 sm:max-h-96 overflow-y-auto">
                        ...
                        {activeTab === 'podcast' && (
                          <p className="text-gray-300 whitespace-pre-wrap text-xs sm:text-base">{fullStory.podcastContent}</p>
                        )}
                        {activeTab === 'gptvoice' && (
                          <div className="text-gray-300 whitespace-pre-wrap text-xs sm:text-base">
                            <div className="bg-gray-700 p-3 rounded-md mb-3 border-l-4 border-green-500 relative">
                              ...
                              <Button
                                onClick={() => {
                                  // Chuẩn bị nội dung bao gồm hướng dẫn và nội dung podcast
                            ...
                            <p className="text-gray-300">{fullStory.podcastContent}</p>
                          </div>
                        )}
                      </div>
                    </div>
